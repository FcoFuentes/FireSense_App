...
class MissionThermal(
    ...
    private lateinit var imageGalleryAdapter: MissionThermal.ImageGalleryAdapter
    override fun onCreateView(
            inflater: LayoutInflater,
            container: ViewGroup?,
            savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.fragment_mission_thermal, container, false)
